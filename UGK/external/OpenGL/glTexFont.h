...
#include <atlstr.h>	//For supporting non MFC CString
...
/**
   ...
   * chars per column. 
*/
	int fontLoadEx(CString name, int row, int col);
/**   
   * @fn fontDrawString
   * Draws a string at (xpos, ypos) in the applications Application.Window.
*/
	void fontDrawString(int xpos, int ypos, CString s, ...);
/**   
   * @fn fontRegion
...
/*  glTexFontTGA.h
    ...
    Web         -- http://members.home.com/vandals1
*/
int fontLoadTGA(CString name, int id); /* id is the texture id to bind too */

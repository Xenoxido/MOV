...
float	CSIK_ActionsDelay	[CSIK_MAX_KBD_ACTION] = {
	...
	200,	//CSIK_PLAYER_SHOOT			Laser fire. 5 shoots per second
...
*/
void CSIKeyboard::UpdateAction(const CK_ACTION Action, bool On)	///<Release a new key from the active list of key pressed
{
	switch (Action)
	{

...
{
	detail::fmat4x4SIMD result;
	detail::sse_transpose_ps(&m[0].Data, &result[0].Data    ñ   ã    e:   CIP_UNSAFE_TO_ABORT $ ®   std::_Num_float_base::radix  e:   CIP_NEED_REBOOT  a;    ServerApplication ' |  €   €ATL::AtlLimits<long>::_Min ' |  €ÿÿÿATL::AtlLimits<long>::